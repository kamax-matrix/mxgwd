...
public class MatrixClientEntityPutHandler extends HttpServerExchangeHandler {

    private Gateway gw;

    public MatrixClientEntityPutHandler(Gateway gw) {
        this.gw = gw;
    }
    ...
    public void handleRequest(HttpServerExchange exchange) throws IOException {
        ...
        long id = Long.parseLong(getParameter(exchange, "id"));
        EntityIO io = GsonUtil.get().fromJson(new String(req.getBody()), EntityIO.class);
        Entity e = gw.getEntity(id);
